                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="level" name="level" required>
                                        ...
                                        <option value="Basic" ${quiz.level eq 'Basic' ? 'selected' : ''}>Basic</option>
                                        <option value="Intermediate" ${quiz.level eq 'Intermediate' ? 'selected' : ''}>Intermediate</option>
                                        <option value="Advanced" ${quiz.level eq 'Advanced' ? 'selected' : ''}>Advanced</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        ...
                                        <option value="Exam" ${quiz.type eq 'Exam' ? 'selected' : ''}>Exam</option>
